...
// API function
// Uses flagcdn.com — a CORS-friendly CDN that returns a { code: name } map
// and serves the matching flag SVGs. Replaces restcountries.com, which
// intermittently drops CORS headers and goes down.
const fetchCountries = async (): Promise<Country[]> => {
  ...
  return Object.entries(data)
    .filter(([code]) => code.length === 2) // keep countries, drop subdivisions
    .map(([code, name]) => ({
      name,
